package com.pzf.liaotian.config;
...
public class ConstantKeys {
    ...
    public static final int MAX_SELECT_IMAGE_COUNT = 6;// 最多选择6张图片
    public static final int ALBUM_PREVIEW_BACK = 3;
    public static final int ABLUM_DISPLAY_TYPE_SINGLE = 0x001;// 相册listview列表的类型
    // 图片消息占位符
     ...
     * 相册图片集
     */
    public static final int ALBUM_IMAGE_GRIDVIEW_DISPLAYTYPE_SINGLE = 0X0001;
